 ...
 * following code extracts the RGB components:
 * <blockquote><pre>
 *  int r = (rgb &gt;&gt; 16) &amp; 0xFF;
 *  int g = (rgb &gt;&gt;  8) &amp; 0xFF;
 *  int b = (rgb &gt;&gt;  0) &amp; 0xFF;
 * </pre></blockquote>
 * Given the RGB components (8-bits each) of a color, the following statement
 * packs it into a 32-bit {@code int}:
 * <blockquote><pre>
 ...
 * by Robert Sedgewick and Kevin Wayne. See {@link GrayscalePicture} for a
 * version that supports grayscale images.
 *
 * @author Robert Sedgewick
 * @author Kevin Wayne
 *
 * Updated file to use CS310 package and reformatted code so that it is easier
 * to read and closer to course coding standards.
 *
 * @author Jeffrey LaMarche
 * @version 1.0 2020-Sept-2 Formatting
 * @version 1.1 2020-Sept-4 Removed the main method
 */
